...
import { ShieldCheck, Check, X } from 'lucide-react-native';
...
export default function TermsGate({ children }: Props) {
  ...
  const handleAcceptInModal = useCallback(() => {
    setAgreed(true);
    setShowTerms(false);
  }, []);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.welcomeWrap}>
        ...
        <Text style={styles.welcomeSubtitle}>
          Your personal space for growth, manifestation, and well-being.
        </Text>
      </View>
      ...
      >
        <View style={styles.modalContainer}>
          <LinearGradient
            colors={['#1a0b2e', '#0c0520']}
            style={StyleSheet.absoluteFill}
          />
          <View style={styles.modalHeader}>
            <View style={styles.iconWrap}>
              <ShieldCheck color="#c4b5fd" size={22} />
            </View>
            <View style={styles.modalHeaderText}>
              <Text style={styles.modalTitle}>Terms & Privacy</Text>
              <Text style={styles.modalSubtitle}>Please review before accepting</Text>
            </View>
            <TouchableOpacity
          ...
          <View style={styles.modalFooter}>
            <TouchableOpacity
              ...
              onPress={handleAcceptInModal}
              activeOpacity={0.85}
              testID="terms-accept-modal-button"
            >
              <LinearGradient
...
const styles = StyleSheet.create({
  ...
  modalFooter: {
    ...
    backgroundColor: 'rgba(8,2,20,0.95)',
  },
  acceptBtn: {
    borderRadius: 14,
    overflow: 'hidden',
